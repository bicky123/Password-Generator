  ...
  constructor(scope: Construct, id: string, props?: PasswordGeneratorPipelineStackProps) {
    ...
    this.pipeline = new pipelines.CodePipeline(this, 'PasswordGeneratorPipeline', {
      ...
      synth: new pipelines.CodeBuildStep('Synth', {
        ...
        installCommands: [
          'rm -rf /root/.dotnet',
          'curl -sSL https://dot.net/v1/dotnet-install.sh | bash /dev/stdin --channel 10.0 --install-dir /root/.dotnet10',
          'ln -sf /root/.dotnet10/dotnet /usr/bin/dotnet',
          'export PATH="/root/.dotnet10:$PATH"',
          'export DOTNET_ROOT="/root/.dotnet10"',
